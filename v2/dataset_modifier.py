...
rows1 = csv_file_to_list_of_rows('best_bad_idioms_8.csv')
rows2 = csv_file_to_list_of_rows('best_bad_europarl_3.csv')
...
with open('full_slayer_dataset.csv', mode='w', newline='') as csv_file:
